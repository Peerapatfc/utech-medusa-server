...
class AuthPhoneProviderService extends AbstractAuthModuleProvider {
	static identifier = 'auth-phone';
	...
	async authenticate(
		...
		const [provider_identitiy] = authIdentity.provider_identities;
...
export default AuthPhoneProviderService;
