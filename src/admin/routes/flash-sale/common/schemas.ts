...
export const PriceListCreateProductVariantSchema = z.object({
...
export const PriceListUpdateProductVariantsSchema = z.record(
	z.object({
		currency_prices: z
			.record(PriceListUpdateCurrencyPriceSchema.optional())
			.optional(),
		region_prices: z
			.record(PriceListUpdateRegionPriceSchema.optional())
			.optional(),
		flash_sale: z
			.object({
				quantity: z.string().or(z.number()).optional(),
