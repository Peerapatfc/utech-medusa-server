...
import type { PromotionType } from '@customTypes/promotion';
...
export const useUpdatePromotionVisibility = (
	id: string,
	options?: UseMutationOptions<
		HttpTypes.AdminPromotionResponse,
		FetchError,
	...
	return useMutation({
		mutationFn: (payload) =>
			sdk.client.fetch(`/admin/custom/promotions/${id}/visibility`, {
				method: 'PATCH',
				body: payload,
			}),
		onSuccess: (data, variables, context) => {
...
export const useUpdatePromotionDetail = (
	...
	return useMutation({
		mutationFn: (payload) =>
			sdk.client.fetch(`/admin/custom/promotions/${id}/detail`, {
				method: 'PATCH',
				body: payload,
			}),
		onSuccess: (data, variables, context) => {
