...
import type { BulkUpdateProductsVariantsType } from "../../types/product";
...
export const useBulkUpdateProducts = (
	options?: UseMutationOptions<any, FetchError, BulkUpdateProductsVariantsType>
) => {
	return useMutation({
		mutationFn: (payload: BulkUpdateProductsVariantsType) =>
			sdk.client.fetch('/admin/custom/products/variants/batch', {
				method: 'POST',
				body: payload,
			}),
		onSuccess: (data, variables, context) => {
